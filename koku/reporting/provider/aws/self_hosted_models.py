...
class AWSLineItemBase(models.Model):
    ...
    product_memory = models.CharField(max_length=50, null=True)
    product_operatingsystem = models.CharField(max_length=50, null=True)

    # Pricing
    pricing_unit = models.CharField(max_length=63, null=True)
